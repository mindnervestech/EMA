...
function saveUpdateQuestionnaire(surveyId){
	   ...
	   if(validationStatus){
		   document.forms[0].action = "Myform_saveQuestionnaire.action?isEventTracker=0&surveyId="+surveyId;
...
<div class="btn " id="b1">
<a href="doctorHome.jsp">Dashboard</a>

</div>

<div class="btn" id="b2"><a href="doctorHome.jsp">Forms</a></div>
<div class="btn" id="b3"><a href="#">People</a></div>
...
<div class="fluid mainCNT home q">  <!-- Large white area - divs to be placed here for content-->
  ...
  <div class="qsteps">
	...
	<div class="btn dis" id="preview"><a href="showQuestionByDoctor">Preview</a></div>
...
<s:if test="hasActionMessages()"><div class="welcome"> <s:actionmessage/></div></s:if>
  ...
  Survey Name:  <s:textfield name="surveyName" id="surveyName" size="39%" /></input>
