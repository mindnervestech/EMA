...
<div class="jcontent">
 ...
 <p>
    <s:form id="base_info" action="MyGroup_uploadUserListNewGroup.action" method="post" enctype="multipart/form-data">
    
       <s:textfield key="Group Name" name="groupName"/>
	   <s:textfield key="Group Desc" name="groupDesc"/>
