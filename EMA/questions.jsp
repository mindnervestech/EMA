...
<body>
<% session.setAttribute("surveyName", request.getParameter("survey")); %>
      ...
      <div class="span9">
        <div class="navbar">
          ...
          <ul class="nav docs-top-nav">
            ...
            <li><a href="javascript:void(0)" title="Click to go About us page">ABOUT US</a></li>
...
<!----------------------page-container-------------------------->
<div id="content" class="container" role="page-container">
  <!--------------------------------------------->
  ...
  <div class="row">
    <div class="span12">
      <div class="btn-group pull-right">
        <button class="btn"><i class="icon-home"></i> Design Survey</button>
        <button class="btn"><i class="icon-home"></i> Collect Responses</button>
        <button class="btn"><i class="icon-home"></i> View Results</button>
      </div>
    </div>
  </div>
  <!--------------------------------------------->
    ...
    <div class="span12">
      <div class="tabbable">
        ...
        <ul class="nav nav-tabs">
          <li><a href="#tab1" data-toggle="tab"><i class="icon-home"></i> Settings</a></li>
          <li class="active"><a href="#tab2" data-toggle="tab"><i class="icon-home"></i> Question Editor</a></li>
          <li><a href="#tab3" data-toggle="tab"><i class="icon-home"></i> Survey Preview</a></li>
          <li><a href="#tab4" data-toggle="tab"><i class="icon-home"></i> Send Survey</a></li>
        </ul>
          ...
          <div class="tab-pane active" id="tab2">
            <div class="row">
              <div class="span12" role="left-menu-containar"> <a href="javascript:void(0)">Questions</a>
                <button class="btn">Reordering</button>
                <button class="btn">Branching</button>
                <button class="btn btn-primary pull-right"> Save Quuestion </button>
              </div>
            </div>
            <!--------------------------------------------->
            <div class="clearfix"></div>
            ...
            <div class="row">
              <div class="span2">
                ...
                <div id="fl_menu">
                  <!--#floating-menu-->
                  <div class="menu"> <a id="page_header" href="javascript:void(0)" class="menu_item"><i class="icon-chevron-up"></i> Page Header</a> </div>
                  <div class="menu"> <a id="multiple_choice" href="javascript:void(0)" class="menu_item"><i class="icon-th-list"></i> Multiple choice</a> <!--<a id="four" href="javascript:void(0)" class="menu_item"><i class="icon-th"></i> Matrix likert</a>--> <a id="rank" href="javascript:void(0)" class="menu_item"><i class="icon-signal"></i> Rank</a> </div>
                  <div class="menu"> <!--<a id="two" href="javascript:void(0)" class="menu_item"><i class="icon-user"></i> Name</a>--> <a id="contact" href="javascript:void(0)" class="menu_item"><i class="icon-envelope"></i> Contact</a> <a id="location" href="javascript:void(0)" class="menu_item"><i class="icon-book"></i> Location </a> <!--<a id="four" href="javascript:void(0)" class="menu_item"><i class="icon-phone"></i> Phone Number</a>--> <a id="date_time" href="javascript:void(0)" class="menu_item"><i class="icon-calendar"></i> Date/Time</a> <!--<a id="three" href="javascript:void(0)" class="menu_item"><i class="icon-mobile"></i> Number</a> <a id="four" href="javascript:void(0)" class="menu_item"><i class="icon-link"></i> URL</a>--> <a id="photo_upload" href="javascript:void(0)" class="menu_item"><i class="icon-upload"></i> Photo Upload</a> <a id="rating_scale" href="javascript:void(0)" class="menu_item"><i class="icon-file"></i> Rating Scale</a> <a id="free_text" href="javascript:void(0)" class="menu_item"><i class="icon-file"></i> Text</a>  </div>
                              ...
                              <div class="q-edit-left">
                                ...
                                <div class="number">00</div>
                                  ...
                                  <div class="q-question">
                                    <input type="text" maxlength="1000" value="Please enter your question here." name="title" required="true">
                                  ...
                                  <div class="q-edit-area">
                                    <div class="edit-bg edit-bg-multi">
                                        ...
                                        <ul id="contain-text-fild" class="sortable multi ui-sortable">
                                          ...
                                          <li class="multi-answer">
                                            <div class="answer-container"> <img alt="Drag Handle" src="images/ico-move.png">
                                              <input type="text" class="" value="Option 1" id="text_opt_1" name="text_opt_1">
                                            </div>
                                          ...
                                          <li class="multi-answer">
                                            <div class="answer-container"> <img alt="Drag Handle" src="images/ico-move.png">
                                              <input type="text" class="" value="Option 2" id="text_opt_2" name="text_opt_3">
                                            </div>
                                            <a class="btn btn-small margin-left10 media-insert" href="javascript:void(0)"><i class="icon-camera"></i> Media</a> <a class="btn btn-small remove-text-field" href="javascript:void(0)" style="visibility:collapse"><i class="icon-remove"></i> Delete</a>
                                            <!--------------------------------->
                                            <div class="clearfix"></div>
                                      ...
                                      <div class="input optional_comments">
                                        <label>Comments:
                                          <input type="text" maxlength="100" tabindex="4" value="Please help us understand why you selected this answer" name="comment_text">
                                        </label>
                                      </div>
                                      <p class="clear"></p>
                                    </div>
                            ...
                            <form method="post" action="">
                              <div class="q-edit-left">
                                ...
                                <div class="q-body">
                                  ...
                                  <p class="clear"></p>
                                  <div class="q-question">
                                    <input type="text" maxlength="1000" value="Please enter your question here." name="title">
                                    <a class="btn btn-small media-insert" href="javascript:void(0)"><i class="icon-camera"></i> Media</a> </div>
                                  <!--------------------------------->
                                  <div class="clearfix"></div>
                                  <!--------------------------------->
                                    ...
                                    <div class="edit-bg edit-bg-multi">
                                      ...
                                      <div class="multi-edit-normal">
                                        <ul id="contain-text-fild" class="sortable multi ui-sortable">
                                          ...
                                          <li class="multi-answer">
                                            <div class="answer-container"> <img alt="Drag Handle" src="images/ico-move.png">
                                              <input type="text" class="" value="Option 1" name="#">
                                            </div>
                                            <a class="btn btn-small margin-left10 media-insert" href="javascript:void(0)"><i class="icon-camera"></i> Media</a> <a class="btn btn-small remove-text-field" href="javascript:void(0)" style="visibility:collapse"><i class="icon-remove"></i> Delete</a>
                                            <!--------------------------------->
                                            <div class="clearfix"></div>
                                          ...
                                          <li class="multi-answer">
                                            <div class="answer-container"> <img alt="Drag Handle" src="images/ico-move.png">
                                              <input type="text" class="" value="Option 2" name="#">
                                            </div>
                                            <a class="btn btn-small margin-left10 media-insert" href="javascript:void(0)"><i class="icon-camera"></i> Media</a> <a class="btn btn-small remove-text-field" href="javascript:void(0)" style="visibility:collapse"><i class="icon-remove"></i> Delete</a>
                                            <!--------------------------------->
                                            <div class="clearfix"></div>
    ...
    <div class="row">
      <div class="span8">
        <div class="navbar">
          <!--#Footer Menu-->
          <ul class="inline">
            <li><a href="javascript:void(0)" title="Click to go Home Page">HOME</a></li>
            <li><a href="javascript:void(0)" title="Click to go About us page">ABOUT US</a></li>
            <li><a href="javascript:void(0)" title="Click to go Contact us Page">CONTACT</a></li>
          </ul>
        </div>
        <!--#Footer Menu-->
        <hr>
      ...
      <div class="span4">
        ...
        <hr>
        <ul class="nav inline">
          <li><a href="javascript:void(0)" title="Connect with us on facebook"><span class="cool-black cool-facebook"></span></a></li>
          <li><a href="javascript:void(0)" title="Connect with us on twitter"><span class="cool-black cool-twitter"></span></a></li>
          <li><a href="javascript:void(0)" title="Connect with us on google plus"><span class="cool-black cool-google-plus"></span></a></li>
          <li><a href="javascript:void(0)" title="Connect with us on youtube"><span class="cool-black cool-youtube"></span></a></li>
          <li><a href="javascript:void(0)" title="Connect with us on skype"><span class="cool-black cool-skype"></span></a></li>
        </ul>
      </div>
      <!--#Footer Social box-->
      <!--------------------------------------------->
...
<div class="container-fluid page_copyright_">
  <!--#Copyright-->
  <p class="text-center"><small>EMA 365 © 2013 all right reserved</small></p>
</div>
<!--#Copyright-->
