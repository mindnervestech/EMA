          ...
          <dd>
            <ul>
             <li><a href="importUserList.action">Import a List<img class="flag" src="fr.png" alt="" /><span class="value">FR</span></a></li>
              ...
              <li><a href="Register_createPatient.action?registrationType=patient">Enter Individual<img class="flag" src="br.png" alt="" /><span class="value">BR</span></a></li>
...
<div class="jcontent">
 ...
 <p>
    <s:form id="base_info" action="Register_createPatient.action?registrationType=patient" method="post" enctype="multipart/form-data">
  ...
  <div class="dashbrd">
   ...
   <div class="indBar"><img src="_images/dashPnt.png" class="p1"><img src="_images/dashPnt.png" class="p2 hidden">
    ...
    <div class="lbar"></div>
      ...
      <div class="btn myData"><a href="mydata">My Data</a></div>
