<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.bayessoft.ema.model.QuestionContact" %>
...
<div class="wrapper">
	...
	<div class="mainMenuSection">
        ...
        <a href="peopleHead" class="menuBtns"><div class="help"><!-- People --></div></a>
        <a href="#"  class="setting"></a>
       <!--  <a href="#"  class="addGreenBtn">New Study</a> -->
    </div>
    <div class="contentSection">
      <div class="sectionMenu"> <a href="newQuestionnaire.jsp" >Form Setting</a> <a href="qPageDev.jsp">Form Construction</a> <a href="showQuestionByDoctor"  class="active">Preview</a> <a href="Distribute_DistributeGroupView">Distribute</a> </div>
	...
	<s:form id="submitAnswer" action="#" method="post">
		 ...
		 <s:iterator value="listQuest" status="stat">
          ...
          <div class="row" id='<s:property value="#stat.index" />' >
        	<div class="listNumber" ><%-- <s:property value="#stat.count" /> --%><%-- <s:property value="#stat.index" /> --%></div>
          ...
          <div class="row">
            ...
            <div class="questionArea">
            	<div class="question" id='<s:property value="%{questionType.getqTypeName()}" />'>	<s:property value="%{questionTitle}" /><span class="mandatory">*</span></div>
				  	...
				  	<s:iterator value="%{questionDAO.getQuestionContactAttributes(id)}" >
